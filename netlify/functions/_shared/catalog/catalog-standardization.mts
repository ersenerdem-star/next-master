...
export function isCatalogPlaceholderDescription(value: string, productCode = ""): boolean {
...
export function pickCatalogDescription(candidates: Array<string | null | undefined>, productCode = ""): string {
...
export function normalizeCatalogEan(value: string): string {
  const text = String(value || "")
    .replace(/\s+/g, " ")
    .trim();
  if (!text) return "";
...
function hasMeaningfulDescriptionWord(text: string): boolean {
