...
const BRAND_STANDARDS = [
  ...
  {
    keys: ["BORGWARNER", "BORGWAGNER"],
    canonical: "BorgWarner",
    sparetoQuery: "BORGWARNER",
    sparetoSlug: "borgwarner",
  },
  {
    keys: ["GARRETT"],
    canonical: "Garrett",
    sparetoQuery: "GARRETT",
    sparetoSlug: "garrett",
  },
  {
    keys: ["KKK"],
  ...
  },
  {
    keys: ["SCHWITZER"],
    canonical: "Schwitzer",
    sparetoQuery: "SCHWITZER",
    sparetoSlug: "schwitzer",
  },
  {
    keys: ["IHI"],
    canonical: "IHI",
  ...
  {
    keys: ["MITSUBISHI TURBOCHARGERS", "MITSUBISHITURBOCHARGERS"],
    canonical: "Mitsubishi Turbochargers",
    sparetoQuery: "MITSUBISHI TURBOCHARGERS",
    sparetoSlug: "mitsubishi-turbochargers",
  },
  {
    keys: ["BERU"],
    canonical: "Beru",
