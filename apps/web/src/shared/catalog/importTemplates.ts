import { downloadCsv, toCsv } from "../data/csv";

export function downloadCatalogTemplate() {
  downloadCsv(
    "catalog-import-template.csv",
    toCsv([
      ["Product_Code", "Brand", "Product_Name", "EAN", "OEM_No", "Vehicle", "Vehicle_Model", "HS_Code", "Origin", "Weight_kg", "Market_Segment"],
      ["0986332404", "Bosch", "Starter", "3165141234567", "1519524", "Mercedes-Benz, MAN", "Actros, Atego", "851140", "HU", "3.142", "Truck"],
    ]),
  );
}
