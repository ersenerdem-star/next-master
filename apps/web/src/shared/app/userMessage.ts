    ...
    typeof message === "string"
      ...
      : message instanceof Error
        ...
        : message && typeof message === "object"
          ? String(
              (message as { message?: unknown; error?: unknown; msg?: unknown; details?: unknown; hint?: unknown }).message ||
                (message as { message?: unknown; error?: unknown; msg?: unknown; details?: unknown; hint?: unknown }).error ||
                (message as { message?: unknown; error?: unknown; msg?: unknown; details?: unknown; hint?: unknown }).msg ||
                (message as { message?: unknown; error?: unknown; msg?: unknown; details?: unknown; hint?: unknown }).details ||
                (message as { message?: unknown; error?: unknown; msg?: unknown; details?: unknown; hint?: unknown }).hint ||
                "",
            ).trim()
          : String(message || "").trim();
  if (!raw) return fallback;
  if (raw === "[object Object]") return fallback;
...
export function isExplicitSessionExpiryMessage(message: unknown) {
  const normalized =
    typeof message === "string"
      ? message.toLowerCase()
      : message instanceof Error
