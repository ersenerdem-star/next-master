...
export function SuppliersPage() {
  ...
  function buildSupplierExportRows() {
    return [
  ...
  function handleSupplierExport() {
    ...
    const exportRows = buildSupplierExportRows();
  ...
  function handleSupplierExportExcel() {
    setExportingSuppliers(true);
    actionFeedback.begin("Preparing supplier Excel export...");
    const blob = buildXlsxBlob("Supplier Export", buildSupplierExportRows(), [5, 7, 8]);
    downloadBlob("supplier-export.xlsx", blob);
    actionFeedback.succeed("Supplier Excel downloaded.");
    setExportingSuppliers(false);
  }
      ...
      <section className="section-card">
        <div className="section-card__header section-card__header--row">
          ...
          <div className="toolbar toolbar--wrap">
            ...
            <Button variant="secondary" onClick={handleSupplierExportExcel} disabled={!rows.length} busy={exportingSuppliers} busyLabel="Preparing...">
              Export Excel
            </Button>
            <Button
              variant="secondary"
