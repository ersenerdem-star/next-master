...
export function CustomersPage() {
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      try {
        ...
        const statementRange = getStatementPeriodBounds(statementPeriodType, statementAnchorDate);
        const [invoiceRows, paymentRows] = await Promise.all([
          fetchInvoicesByCustomerNamesInRange(names, statementRange),
          fetchPaymentsReceivedByCustomerNamesInRange(names, statementRange),
        ]);
        if (cancelled) return;
  ...
  }, [actionFeedback, selectedCustomer, statementPeriodType, statementAnchorDate]);
