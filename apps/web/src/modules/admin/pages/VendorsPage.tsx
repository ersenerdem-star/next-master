...
import {
  fetchBillsBySupplierNamesInRange,
  fetchPaymentsMadeBySupplierNamesInRange,
...
export function VendorsPage() {
    ...
    async function run() {
      ...
      try {
        ...
        const [billRows, paymentRows] = await Promise.all([
          fetchBillsBySupplierNamesInRange(names, statementRange),
          fetchPaymentsMadeBySupplierNamesInRange(names, statementRange),
        ]);
        if (cancelled) return;
        setBills(billRows);
  ...
  }, [actionFeedback, selectedVendor, statementPeriodType, statementAnchorDate]);
